...
class movement(products):
    ...
    def movement_by_product(product,move):
        ...
        print(f"{product.name}:{product.stock_at_locations}")
        print("---------------------------------------------------------------------")
...
prod5=products("Hard disk","005","electric things","10000",{'warehouse':200,'store2':10})
# movements=[
